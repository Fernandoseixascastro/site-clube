        ...
        <div class="col-12" style="margin-top: 50px;">
            <div class="panel panel-primary filterable w-100 table-responsive-xl">
                <div class="panel-heading">
                    <h3 class="panel-title">Voucher's Ativos</h3>
                ...
                <table class="table">
                    <thead class="thead-light">
                        <tr class="filters">
                            ...
                            <th><input type="text" class="form-control form-filter" placeholder="Cliente" disabled></th>
                            <th><input type="text" class="form-control form-filter" placeholder="CPF" disabled></th>
                    ...
                    <tbody>
                        <?php listarVoucherShop('voucher','infoconvenios','usuarios','idEmpresa',$_SESSION['usuarioCPF'],'utilizado','nao'); ?>
                    </tbody>
                </table>
            </div>
        </div>
